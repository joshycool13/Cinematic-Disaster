...
if (product = "castagent") {
	draw_sprite_stretched(spr_hire_castagent_idle, 0, x+32, y+16, 64, 64)
	
} else if (product = "janitor") {
	draw_sprite_stretched(spr_hire_janitor_broom_ready, 0, x+32, y+16, 64, 80)
	
} else if (product = "makeup") {
	draw_sprite_stretched(spr_hire_makeup_copy, 0, x+32, y+16, 64, 64)
	
} else if (product = "boomcrew") {
	draw_sprite_stretched(spr_hire_boomcrew_bomb_aiming, 0, x+32, y+16, 64, 64)
	
} else if (product = "janewick") {
	draw_sprite_stretched(spr_hire_janewick_gun_idle, 0, x+32, y+16, 64, 64)
}
