...
if x > max_screen_awayness + window_get_width() and not finished_round_trip
{
	finished_round_trip = true
	var remaining_x = x - max_screen_awayness - window_get_width()
	x = -max_screen_awayness + remaining_x
}
